...
Yj = np.array([0.5, 1.0e52, 0.05, 0.5, 0.0, 0.0, 0.0, 1.0e-3, 2.2, 0.1, 0.01, 1.0, 1.0e26])
Yc = np.array([10.0, 1.0, 1.0e55, 5, 1.0e-7, 0.0, 0.0, 0.0, 1.0e-3, 2.2, 0.1, 0.01, 1.0, 1.0e26])
